...
os.system('cd ~/sat/sat/gen0/mutation/delay && python hspice_delay.py > /dev/null')
# os.system('cd ' + cdir + 'gen0/mutation/leakage && python hspice_leakage.py')
os.system('cd ~/sat/sat/gen0/mutation/leakage && python hspice_leakage.py &> /dev/null')
# os.system('cd ' + cdir)
os.system('cd ~/sat/sat')
...
for i in range(1,2000):
    ...
    os.system('cd ~/sat/sat/gen'+str(i)+'/mutation/delay && python hspice_delay.py > /dev/null')
    # os.system('cd ' + cdir + 'gen' + str(i) + '/mutation/leakage && python hspice_leakage.py')
    # os.system('cd ' + cdir)
    os.system('cd ~/sat/sat/gen'+str(i)+'/mutation/leakage && python hspice_leakage.py > /dev/null')
    os.system('cd ~/sat/')
